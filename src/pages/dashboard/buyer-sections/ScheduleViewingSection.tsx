    ...
    return (
      <div className="flex items-center justify-center h-full">
        <div className="text-center">
          ...
          <p className="text-gray-500 mt-2">Select a property to schedule a viewing</p>
        </div>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500">Book a viewing for {property.address.street}</p>
        </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
        <div className="text-center">
          ...
          <p className="text-gray-500 mt-2">The viewing scheduling feature will be available soon.</p>
        </div>
      </div>
    </div>
  );
