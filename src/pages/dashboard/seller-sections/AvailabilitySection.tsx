        ...
        <div className="flex items-center gap-2 ml-auto">
          {availabilityDates.length > 0 && (
            <button 
              ...
              className="px-4 py-2 border border-red-200 text-red-600 rounded hover:bg-red-50 transition"
            >
              Clear All
            </button>
          )}
          <button 
            ...
            disabled={isSaving}
            className={`px-4 py-2 bg-emerald-50 text-emerald-700 border border-emerald-200 rounded hover:bg-emerald-100 transition flex items-center ${
