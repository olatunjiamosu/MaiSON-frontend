...
import { 
  Home, FileText, Settings, Calendar, Bell, 
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      >
        ...
        <nav className="p-4 space-y-1">
          <NavItem icon={<List />} label="All Listings" active={activeSection === 'listings'} onClick={() => setActiveSection('listings')} path="/buyer-dashboard" />
          <NavItem icon={<Handshake />} label="Property Matches" active={activeSection === 'matches'} onClick={() => setActiveSection('matches')} path="/buyer-dashboard/matches" />
          <NavItem 
            icon={<Heart />} 
          ...
          />
          <NavItem icon={<ClipboardList />} label="Applications" active={activeSection === 'applications'} onClick={() => setActiveSection('applications')} path="/buyer-dashboard/applications" />
          <NavItem icon={<MessageCircle />} label="Messages" active={activeSection === 'messages'} onClick={() => setActiveSection('messages')} path="/buyer-dashboard/messages" />
          <NavItem icon={<Bell />} label="Notifications" active={activeSection === 'notifications'} onClick={() => setActiveSection('notifications')} path="/buyer-dashboard/notifications" />
          <NavItem icon={<Settings />} label="Preferences" active={activeSection === 'preferences'} onClick={() => setActiveSection('preferences')} path="/buyer-dashboard/preferences" />
          <NavItem icon={<FileText />} label="Documents" active={activeSection === 'documents'} onClick={() => setActiveSection('documents')} path="/buyer-dashboard/documents" />
        </nav>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <main className="flex-1 overflow-y-auto p-8">
          <div className="max-w-7xl mx-auto">
            <Routes>
              <Route index element={<ListingsSection properties={mockProperties} />} />
